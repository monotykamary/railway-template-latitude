...
- Latitude `v0.3.92`: web UI, public API/MCP server, OTLP ingest, BullMQ workers, Temporal workflows, and one-shot migrations
...
`v0.3.92` is the newest stable Latitude tag with a complete six-image publication. The newer `v0.3.84` image workflow was cancelled, so this template will not mix application versions or substitute a development build.

Upstream release workflow evidence: [v0.3.92 publish succeeded](https://github.com/latitude-dev/latitude-llm/actions/runs/33851274441), with all six service image jobs green.
...
| Component | Version |
| --- | --- |
| Latitude applications | `0.3.92` at per-image OCI digests |
| pgvector PostgreSQL | `0.8.1-pg16` |
| ClickHouse | `26.2.19.43` |
| Redis | `7.4.7-alpine` |
| Temporal auto-setup | `1.27.2` |
| Upstream source | [`2c129d80d27f2f5c96dec1a889cca38217f862f2`](https://github.com/latitude-dev/latitude-llm/tree/2c129d80d27f2f5c96dec1a889cca38217f862f2) |
...
- [Stable source tag](https://github.com/latitude-dev/latitude-llm/tree/v0.3.92)
